...
import ContactCorporate from '../components/CorporatePage/ContactCorporate';
import FooterCorporate from '../components/CorporatePage/FooterCorporate';
import LegalCorporate from '../components/CorporatePage/LegalCorporate';
...
const BottomAboutShape = styled.div`
  ${BottomShape}
  background-color: white;
  clip-path: polygon(
    100% 0%,
